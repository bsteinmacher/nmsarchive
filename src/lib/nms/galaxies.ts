/**
 * RealityIndex 0–255 no JSON / .nmsitem / Prisma; a UI mostra 1–256.
 * Nomes da wiki / comunidade (lista estável desde Atlas Rises).
 */
...
export function galaxyName(index: number): string | undefined {
  if (!Number.isInteger(index) || index < 0 || index >= GALAXY_NAMES.length) {
    return undefined;
  }
